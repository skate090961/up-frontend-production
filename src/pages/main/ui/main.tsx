...
const MainSectionLayout = ({
    ...
    return (
        <Section size="4">
            ...
            <Box>
                <Flex direction="column" justify="center" align="center" mb="7">
                    <Badge size="2" mb="2">
                        {badge}
                    </Badge>
    ...
    return (
        <>
            ...
            <MainSectionLayout
                ...
                subtitle="Up Frontend provides all the resources you need to build impressive projects without wasting time on design decisions."
            >
                <Grid
            ...
            <MainSectionLayout
                ...
                subtitle="Get from idea to implementation in just a few simple steps."
                withGradient
            >
                <Grid
                    columns={{ initial: '1', sm: '2', md: '3' }}
            ...
            <MainSectionLayout
                ...
                subtitle="From simple landing pages to complex applications, find the perfect project to enhance your skills."
            >
