...
import AppSelect, {Option} from "@/components/AppSelect/AppSelect";
import {ChangeEvent, useState} from "react";
import {Box, Button, Card, Flex, Grid, TextField} from "@radix-ui/themes";
import {MagnifyingGlassIcon, MixerHorizontalIcon} from "@radix-ui/react-icons";
import {ComplexityLevel, Tech} from "@/pages/ProjectsPage/ProjectsPage";
...
const ProjectFilter = (props: ProjectFilterProps) => {
    ...
    return (
        <Box mb={'5'}>
            ...
            {filterIsOpen && (
                <Card mt={'3'}>
                    <Grid gap={'3'} columns={{initial: "1", sm: "3", md: "3"}} gap="3" width="auto">
                        <AppSelect
                            value={techValue}
